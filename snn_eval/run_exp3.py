...
import argparse
import torch
from . import models, inference, metrics, data, fusion
...
def main():
    ...
    # calibration split for trust estimation
    ...
    # trust per source from calibration counts: t = (n_correct+1)/(n_total+2)
    trusts, pb_test = [], []
    for m in sources:
